      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12 sm:px-6 lg:px-8 relative">
        ...
        <div className="w-full max-w-sm relative z-10">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <a href="#" className="font-medium text-slate-500 hover:text-[#1b9e75] transition-colors">
                      Forgot password?
                    </a>
                  </div>
                </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            ...
            <Link href="/signup" className="font-semibold leading-6 text-[#1b9e75] hover:text-[#147b5b] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
